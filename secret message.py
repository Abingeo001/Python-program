...
def decrypt():
    ...
    if password=="1234":
        ...
        Label(screen2,text="DECRPT",font="arial",fg="white",bg="#ed3833").place(x=10,y=0)
...
def encrypt():
    ...
    if password =="1234":
        ...
        text2=Text(screen1,font="Rpbote 10",relief=GROOVE,wrap=WORD,bd=0)
...
def main_screen():
    ...
    Label(text="Enter secrete key for encryption and decryption",fg="black",font=("calbri",13)).place(x=10,y=170)
    code=StringVar()
